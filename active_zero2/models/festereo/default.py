...
from active_zero2.models.festereo.unet_parts import NConv, Down, Up
import math
...
class DefaultModel(nn.Module):
    ...
    def compute_disp_loss(self, data_batch, pred_dict):
        ...
        loss_disp += F.smooth_l1_loss(pred_dict['disparity'][mask], disp_gt[mask], reduction="mean")
    ...
    def compute_reproj_loss(self, data_batch, pred_dict, use_mask: bool, patch_size: int, only_last_pred: bool):
        ...
        loss_reproj = compute_reproj_loss_patch(
            ...
            pred_disp_l=pred_dict["disparity"],
            mask=mask,
            ps=patch_size,
        )
